...
export default function AdminUsersPage() {
  ...
  return (
    <Provider theme={defaultTheme} router={{ navigate, useHref }}>
      ...
      <div className="w-screen min-h-screen flex flex-col bg-gradient-to-br from-gray-200 via-gray-300 to-gray-400 p-6">
        <Breadcrumbs>
        ...
        <div className="mt-4 w-full md:w-4/5 self-center p-6 bg-white/60 rounded-lg shadow-lg backdrop-blur-sm">
